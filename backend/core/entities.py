...
if TYPE_CHECKING:
    from backend.core.translate.types import TargetLanguage
...
class TranscribeConfig:
    ...
    def print_config(self) -> str:
        ...
        if self.transcribe_model == TranscribeModelEnum.FASTER_WHISPER:
            lines.append(
...
class SubtitleConfig:
    ...
    def print_config(self) -> str:
        ...
        if self.need_translate:
            ...
            if self.translator_service == TranslatorServiceEnum.LLM:

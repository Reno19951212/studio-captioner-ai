...
try:
    from backend._version import __version__ as _raw_version
    # Strip dev suffix (e.g. "1.5.0.dev103+g38544177c" → "1.5.0")
    VERSION = _raw_version.split(".dev")[0]
except Exception:
    VERSION = "0.0.0-dev"
YEAR = 2026
APP_NAME = "studio-captioner-ai"
AUTHOR = "Studio Captioner AI"

HELP_URL = "https://github.com/studio-captioner-ai/studio-captioner-ai"
GITHUB_REPO_URL = "https://github.com/studio-captioner-ai/studio-captioner-ai"
RELEASE_URL = "https://github.com/studio-captioner-ai/studio-captioner-ai/releases/latest"
FEEDBACK_URL = "https://github.com/studio-captioner-ai/studio-captioner-ai/issues"
...
if _IS_DEV:
    ...
    WORK_PATH = Path.home() / "studio-captioner-ai"
